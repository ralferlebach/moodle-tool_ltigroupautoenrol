...
$string['pluginname'] = 'Automatic enrolment in groups by LTI deployment';
$string['coursemenu_item'] = 'LTI-enrol in groups bla bla';

// Buttons and links.
$string['menu_auto_groups'] = 'LTI-enrol in groups bli blubb';
